            ...
            <div class="row">
                <div class="col-md-12 text-center" id="header">
                   ...
                   <ul>
                       ...
                       <li><a style="color: orange;" href="user_logout.php">Logout <?php echo $_SESSION['username']; ?></a></li>
                   </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">                                 
                    ...
                    <div id="car">
                        ...
                        <h3>Total space :- <span> 05</span> </h3>
                        <?php
                            if($num != 5){
                                ?>
                                <h3>Parking Booked space :- <span><?php echo $num ?> </span> </h3>
                                <h3>Total Available space :- <span> <?php echo (5-$num) ?></span> </h3>
                                <?php
                            }else{                    
                ...
                <table class="table table-striped" id="table" >
                    ...
                    <tbody>                      
                        <tr>
                            ...
                            <td><a href="admin/delete-inline.php?Token_number=<?php echo $row['Token_number']?>">Delete</a></td>
                        </tr>  
                    </tbody>
                    <?php
                    }
